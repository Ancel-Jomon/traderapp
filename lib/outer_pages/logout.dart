            ...
            onSelected: (value) async {
                  switch (value) {
                    case MenuActions.logout:
                     ...
                     if (logoutvalue) {
                      FireBaseAuthentication().signOut().then((value) =>  gotoLogin(context));
...
Future<bool> showLogoutDialog(BuildContext context) {
  return showDialog<bool>(
    context: context,
    builder: (context) {
      return AlertDialog(title: const Text('sign out'),content: const Text('are you sure'),
        actions: [
...
void gotoLogin(BuildContext context){ Navigator.of(context).pushNamedAndRemoveUntil('/LoginOrRegister',(route) => false);}