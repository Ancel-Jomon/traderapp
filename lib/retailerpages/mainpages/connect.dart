...
class Rconnect extends StatefulWidget {
  const Rconnect({super.key});

  @override
  State<Rconnect> createState() => _MyAppState();
}

class _MyAppState extends State<Rconnect> {
  String id = '';
  double _opacity = 1.0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Retailer Connect'),
      ),
      body: Padding(
